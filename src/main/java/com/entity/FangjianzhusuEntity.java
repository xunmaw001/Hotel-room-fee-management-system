...
public class FangjianzhusuEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public FangjianzhusuEntity() {

	}

	public FangjianzhusuEntity(T t) {
		try {
    ...
    public String toString() {
        return "Fangjianzhusu{" +
            "id=" + id +
            ", fangjianId=" + fangjianId +
            ", yonghuId=" + yonghuId +
            ", fangjianzhusuName=" + fangjianzhusuName +
            ", fangjianzhusuPhone=" + fangjianzhusuPhone +
            ", fangjianzhusuTime=" + fangjianzhusuTime +
            ", zhusuNumber=" + zhusuNumber +
