...
import center from '@/views/center'
    ...
    import fangjianzhusu from '@/views/modules/fangjianzhusu/list'
    import news from '@/views/modules/news/list'
    import yonghu from '@/views/modules/yonghu/list'
    import dictionaryCaiwu from '@/views/modules/dictionaryCaiwu/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryCaiwu',
        name: '财务类型',
        component: dictionaryCaiwu
    }
    ,{
